/**
 * ArbiChain - Shared Types and Constants
...
const FilecoinContentType = {
  TASK_SPEC: 'arbichain_task_spec',
  DELIVERABLE: 'arbichain_deliverable',
  EVIDENCE: 'arbichain_evidence',
  ARBITRATION_REPORT: 'arbichain_arbitration_report'
};
